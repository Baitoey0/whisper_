  ...
  document.getElementById('loginBtn').addEventListener('click', async () => {
    ...
    try {
      ...
      if (data.error) {
        ...
        // reliance solely on cookies and supports multi‑device login.
        if (data.userId) {
          localStorage.setItem('whisperUserId', data.userId);
          localStorage.setItem('whisperUsername', data.username);
        }
